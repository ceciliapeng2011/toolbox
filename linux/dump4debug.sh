...
# Modify it accordingly w.r.t model
SDPA_COUNT=36


run_llm_app() {
    model_dir=$HOME/llm_irs/WW05_llm-optimum_2026.0.0-20947/qwen3-8b/pytorch/ov/OV_FP16-4BIT_DEFAULT
    # model_dir=$HOME/llm_irs/WW05_llm-optimum_2026.0.0-20947/phi-3-mini-128k-instruct/pytorch/ov/OV_FP16-4BIT_DEFAULT
    # model_dir=$HOME/llm_irs/WW05_llm-optimum_2026.0.0-20947/minicpm4-8b/pytorch/ov/OV_FP16-4BIT_DEFAULT
...
# mkdir -p dump_xattn_mask_bs256
# export DUMP_XATTN_INTERNALS=./dump_xattn_mask_bs256/
run_llm_app
#  > log 2>&1
